          ...
          >
            ...
            <Grid columns={12} gutter={0}>
              ...
              <Grid.Col span={10.5}>
                <Flex
                  justify="flex-start"
                  direction="column"
                  ml={{ base: "xs", sm: 0, md: 0 }}
                  pl={"lg"}
                >
                  <Text fw={700} size="lg">
                    {t("Name")}
                  </Text>
                  <Text style={{ color: "dimmed" }}>{formValues?.name}</Text>
                </Flex>
                <Divider mt="xs" />
              </Grid.Col>
            </Grid>
            ...
            <Grid columns={12} gutter={0} mt="xs">
              ...
              <Grid.Col span={10.5}>
                ...
                >
                  ...
                  <Text style={{ color: "dimmed" }}>{formValues?.mobile}</Text>
                </Flex>
                <Divider mt="xs" />
              </Grid.Col>
            </Grid>
            <Grid columns={12} gutter={0} mt="xs">
              ...
              <Grid.Col span={10.5}>
                ...
                >
                  ...
                  <Text style={{ color: "dimmed" }}>{formValues?.email}</Text>
                </Flex>
                <Divider mt="xs" />
              </Grid.Col>
            </Grid>
            ...
            <Grid columns={12} gutter={0} mt="xs">
              ...
              <Grid.Col span={10.5}>
                ...
                >
                  ...
                  <Text style={{ color: "dimmed" }}>{formValues?.website}</Text>
                </Flex>
                <Divider mt="xs" />
              </Grid.Col>
            </Grid>
            <Grid columns={12} gutter={0} mt="xs">
              ...
              <Grid.Col span={10.5}>
                ...
                >
                  ...
                  <Text style={{ color: "dimmed" }}>{formValues?.address}</Text>
                </Flex>
              </Grid.Col>
            </Grid>
            ...
            >
              <Flex align={"center"} justify={"center"} pt={"sm"}>
                <Text fw={700}>{t("SocialMedia")}</Text>
              </Flex>
            </Box>
            <Flex justify="center" align="center" mt="sm" ml="xl">
              ...
              <Anchor
                href={formValues?.linkedinAccount}
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
              ...
              <Anchor
                href={formValues?.twitterAccount}
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
